      ...
      <v-row class="home-service__contents">
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/rockglass5.webp" alt="ディレクション">
            </div>
        ...
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/rockglass6.webp" alt="コーディング">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
        ...
        <v-col md="3">
          ...
          >
            ...
            <div class="home-service__card-img">
              <img class="icon--service" src="../assets/img/rockglass.webp" alt="デザイン">
            </div>
            <div class="home-service__card-text">
              <p>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
            </div>
